...
class BleService : Service() {
 ...
 // FIX v3.4.1-ARCH: Constantes NAP agregadas defensivamente para evitar desfase futuro
 ...
 fun startScan() {
 if (isScan) {
 Log.w(TAG, "[NAP-SCAN-001] Scan already active, ignoring")
 return
 }
 ...
 isScan = false
 Log.i(TAG, "[NAP-SCAN-008] stopScan() ejecutado. Resultados=${scanResults.size}")
