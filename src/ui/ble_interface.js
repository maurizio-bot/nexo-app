rm -f src/ui/ble_interface.js && cat << 'EOF' > src/ui/ble_interface.js
/**
 * BLE Interface v3.7.2-HEALTH-FIX
 * Ubicacion: src/ui/ble_interface.js
 * FIXES v3.7.2-HEALTH-FIX:
 *    1) openChat: garantiza transport: 'ble' en evento nexo:ble:openChat
 *    2) Name cache inteligente preservado
 *    3) Health Monitor preservado
 *    4) Fragmentacion/Reensamblaje preservado
     */
     ...
     var timeout = setTimeout(function() { reject(new Error('Timeout waiting for BLE server')); }, 8000);
     var check = function() {
     ...
     // FIX v3.7.2: Garantizar transport: 'ble' en el evento
