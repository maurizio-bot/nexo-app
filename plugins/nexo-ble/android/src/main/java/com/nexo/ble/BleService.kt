// ============================================================
// BleService.kt — AUTÓNOMO, sin dependencia de NexoBleSpec
...
class BleService : Service() {
    ...
    companion object {
        ...
        // Inline constants (no dependency on NexoBleSpec)
    ...
    private val gattServerCallback = object : BluetoothGattServerCallback() {
        override fun onConnectionStateChange(device: BluetoothDevice, status: Int, newState: Int) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                broadcast(ACTION_BLE_DEVICE_CONNECTED, device.address)
            } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                connectedDevices.remove(device)
                broadcast(ACTION_BLE_DEVICE_DISCONNECTED, device.address)
        ...
        override fun onCharacteristicWriteRequest(
            ...
            if (characteristic.uuid == RX_CHARACTERISTIC_UUID) {
                ...
                val intent = Intent(ACTION_BLE_MESSAGE_RECEIVED).apply {
