// ============================================================
// NexoBlePlugin.kt — VERSIÓN FUNCIONAL build #961 (corregido compilación)
// plugins/nexo-ble/android/.../NexoBlePlugin.kt
// FIX: Eliminado uso de BleService.ACTION_STOP_ADVERTISING (no existe en
//      BleService.kt funcional). Vuelto a stopService simple.
// ============================================================
...
class NexoBlePlugin : Plugin() {
    ...
    // FIX: stopService simple, sin ACTION_STOP_ADVERTISING
    @PluginMethod
