/**
 * ble_interface.js v3.9.2-ARCH
 *
 * REVERT: Plugin name a NexoBLE (alineado con builds funcionales de permisos)
 * FIX: Solo ajuste de nombre, sin tocar logica de permisos ni eventos
 */
...
export async function initBLEInterface() {
  console.log('[BLE_INIT] Inicializando BLE Interface v3.9.2-ARCH');
