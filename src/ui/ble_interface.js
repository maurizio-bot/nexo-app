/**
 * BLE Interface v5.0.0-DUAL-GATT-ES5
 ...
 * ES5 syntax compatible con webpack - NO async/await en metodos de clase
   */
   ...
   console.log('[BLEInterface] DUAL GATT v5.0.0-ES5 iniciado. MAC maps:', this._uuidToMacMap.size, 'entradas');
   }
   _detectMeshType() {
