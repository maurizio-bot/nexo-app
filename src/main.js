 ...
 *    * Implementación de _fmtTime para formato de tiempo.
 *    * Implementación de _getAttachmentPlugins para plugins de Capacitor.
 *    * Implementación de _getCurrentContactId para gestión de contactos.
 *    * Implementación de _sendAttachment para envío de adjuntos.
 *    * Corrección en _handleCameraCapture para captura de video.
 *    * Implementación de _setupVideoRecorder para MediaRecorder.
 *    * Implementación de _startCameraPreview y _stopCameraPreview.
 *    * Implementación de _handleLocation y _handleLocationFallback.
 *    * Implementación de _handleVoiceToggle.
 *    * Implementación de _bindAttachmentHandlers con soporte para long-press.
 *    * Implementación de lógica de persistencia de mensajes (localStorage).
 *    * Implementación de _renderMessage para renderizado de mensajes con adjuntos.
 *    * Implementación de _updateMessageStatus y _toggleVaultUI.
 *    * Implementación de gestión de permisos en el arranque.
     */
