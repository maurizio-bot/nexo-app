...
DEBUG.success(町 Chat activo: ${name} [${transport.toUpperCase()}], 'BLE_CHAT');
...
if (targetId && targetTransport === 'ble' && this.bleInterface?.sendChatMessage) {
try {
await this.bleInterface.sendChatMessage(targetId, content);
