/**
 * ble_interface.js v5.1.2-ACK-ES5
 * Dual GATT + ACK + Read Receipt + Retry Queue
 * FIX: ES6 export nativo para webpack
 */

export var SERVICE_UUID = '0000abcd-0000-1000-8000-00805f9b34fb';
export var RX_CHAR_UUID = '0000abce-0000-1000-8000-00805f9b34fb';
export var TX_CHAR_UUID = '0000abcf-0000-1000-8000-00805f9b34fb';
...
export function sendChatMessage(mac, text, prebuiltPayload, prebuiltId) {
    var cleanMac = _macWithColons(mac);
...
export function sendReadReceipt(mac, messageIds) {
