...
/* FIX v5.0.13: nexo_app.js maneja el renderizado via _renderMessageToDOM */
/* Solo actualizar estado si el mensaje ya existe en DOM */
if (msg.messageId && msg.status) {
_updateMessageStatus(msg.messageId, msg.status);
}
},
...
/* FIX: Skip if already rendered by nexo_app.js (data-message-id vs data-msg-id) */
var existingApp = document.querySelector('.message[data-message-id="' + msgId + '"]');
if (existingApp) {
if (msg.status) {
