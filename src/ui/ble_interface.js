/**
 * BLE Interface v5.0.8-CONTACTOS-ES5
 * FIX: EYE reactivación al foreground corregida
 * FIX: Tap highlight azul eliminado, scale(0.92) en :active todos los botones
 */
...
export class BLEInterface {
  constructor(bleMesh) {
    ...
    console.log('[BLEInterface] DUAL GATT v5.0.8-CONTACTOS iniciado. MAC maps:', this._uuidToMacMap.size, 'entradas');
  }
  ...
  /* FIX: EYE reactivación al foreground — si NO está advertising, reintentar */
  ...
  injectStyles() {
    ...
    style.textContent = "#ble-tab { position: fixed; left: 0; top: 50%; transform: translateY(-50%); width: 44px; height: 100px; background: #0082FC; border-radius: 0 12px 12px 0; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; z-index: 2147483644; color: #fff; font-weight: bold; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; } .ble-tab-badge { position: absolute; top: 5px; right: -5px; background: #ff4444; color: white; width: 18px; height: 18px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 10px; animation: pulse 2s infinite; } @keyframes pulse { 0%, 100% { transform: scale(1); } 50% { transform: scale(1.1); } } #ble-panel { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: #000000; transform: translateX(-100%); transition: transform 0.3s ease; z-index: 2147483645; color: #fff; display: flex; flex-direction: column; } #ble-panel.active { transform: translateX(0); } #ble-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.6); display: none; z-index: 2147483644; backdrop-filter: blur(4px); } #ble-overlay.active { display: block; } .ble-header { display: flex; align-items: center; justify-content: space-between; padding: 16px 20px; border-bottom: 1px solid #333; } .ble-header h3 { margin: 0; font-size: 18px; color: #fff; flex: 1; text-align: center; } .ble-btn-back { background: none; border: none; color: #0082FC; font-size: 24px; cursor: pointer; padding: 0; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; transition: transform 0.15s ease; } .ble-btn-back:active { transform: scale(0.92); } .ble-btn-visibility-round { width: 48px; height: 48px; border-radius: 50%; border: 2px solid #0082FC; background: rgba(255,255,255,0.05); color: #888; cursor: pointer; font-size: 12px; display: flex; align-items: center; justify-content: center; transition: all 0.3s; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; transition: transform 0.15s ease, background 0.3s, box-shadow 0.3s; } .ble-btn-visibility-round:active { transform: scale(0.92); } .ble-btn-visibility-round.active { background: #0082FC; color: #fff; border-color: #0082FC; box-shadow: 0 0 12px rgba(0,130,252,0.4); } .ble-btn-visibility-round::before { content: 'EYE'; font-size: 10px; font-weight: bold; } .ble-contacts-list { flex: 1; overflow-y: auto; padding: 0 20px; } .ble-contact-item { display: flex; align-items: center; justify-content: space-between; padding: 14px 16px; background: rgba(255,255,255,0.05); border: 1px solid #333; border-radius: 12px; margin-bottom: 10px; cursor: pointer; transition: all 0.2s; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; } .ble-contact-item:hover { background: rgba(0,130,252,0.1); border-color: #0082FC; } .ble-contact-item:active { transform: scale(0.98); } .ble-contact-item.online { border-left: 3px solid #0082FC; } .ble-contact-item.offline { border-left: 3px solid #666; } .ble-contact-item.pinned { border-left: 3px solid #FFD700; } .ble-contact-info { display: flex; flex-direction: column; flex: 1; min-width: 0; } .ble-contact-name { font-weight: 600; font-size: 15px; color: #fff; } .ble-contact-status { font-size: 11px; color: #888; margin-top: 2px; } .ble-contact-actions { display: flex; gap: 8px; } .ble-btn-menu { width: 36px; height: 36px; border-radius: 50%; background: rgba(255,255,255,0.1); color: #fff; border: none; cursor: pointer; font-size: 18px; display: flex; align-items: center; justify-content: center; transition: all 0.2s; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; transition: transform 0.15s ease, background 0.2s; } .ble-btn-menu:hover { background: rgba(0,130,252,0.2); } .ble-btn-menu:active { transform: scale(0.92); } .ble-contact-menu { position: fixed; background: #1a1a1a; border: 1px solid #333; border-radius: 12px; padding: 8px 0; min-width: 160px; z-index: 2147483646; box-shadow: 0 4px 20px rgba(0,0,0,0.5); } .ble-menu-item { padding: 12px 16px; color: #fff; font-size: 14px; cursor: pointer; transition: background 0.2s; display: flex; align-items: center; gap: 8px; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; } .ble-menu-item:hover { background: rgba(0,130,252,0.15); } .ble-menu-item:active { transform: scale(0.98); } .ble-menu-delete { color: #ff4444; } .ble-menu-delete:hover { background: rgba(255,68,68,0.15); } .ble-empty { text-align: center; color: #666; padding: 40px 20px; font-style: italic; } .ble-bottom-bar { display: flex; align-items: center; justify-content: space-between; padding: 16px 20px; border-top: 1px solid #333; gap: 12px; } .ble-new-device { display: flex; align-items: center; gap: 10px; flex: 1; background: rgba(0,130,252,0.1); border: 1px solid #0082FC; border-radius: 12px; padding: 10px 14px; } .ble-new-device span { color: #fff; font-size: 14px; flex: 1; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; } .ble-btn-add-small { width: 36px; height: 36px; border-radius: 50%; background: #0082FC; color: #fff; border: none; font-size: 20px; font-weight: bold; cursor: pointer; display: flex; align-items: center; justify-content: center; flex-shrink: 0; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; transition: transform 0.15s ease; } .ble-btn-add-small:active { transform: scale(0.92); } .ble-btn-scan-round { width: 48px; height: 48px; border-radius: 50%; background: linear-gradient(135deg, #0082FC, #0055AA); color: #fff; border: none; font-size: 10px; font-weight: bold; cursor: pointer; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 4px 15px rgba(0,130,252,0.3); transition: all 0.3s; -webkit-tap-highlight-color: transparent; outline: none; user-select: none; transition: transform 0.15s ease, box-shadow 0.3s; } .ble-btn-scan-round:active { transform: scale(0.92); } .ble-btn-scan-round.scanning { background: linear-gradient(135deg, #ff4444, #cc0000); color: #fff; animation: pulse-red 1.5s infinite; } .ble-btn-scan-round.scanning::before { content: 'STOP'; } .ble-btn-scan-round::before { content: 'SCAN'; font-size: 10px; } @keyframes pulse-red { 0%,100% { box-shadow: 0 0 0 0 rgba(255,68,68,0.4); } 50% { box-shadow: 0 0 0 10px rgba(255,68,68,0); } } .ble-status-bar { display: flex; align-items: center; justify-content: center; padding: 8px 20px; border-top: 1px solid #222; background: rgba(0,0,0,0.8); font-size: 11px; color: #666; } .ble-status-bar span { color: #0082FC; font-weight: 600; }";
