 ...
 * FIX: Mensajes se encolan si canal no listo, se envian al conectar
   */
   ...
   avatarDiv.className = 'ble-online-avatar ' + gradClass;
   avatarDiv.textContent = initials;
   var dotDiv = document.createElement('div');
   dotDiv.className = 'ble-online-dot';
   avatarDiv.appendChild(dotDiv);
   item.appendChild(avatarDiv);
   var nameSpan = document.createElement('span');
   nameSpan.className = 'ble-online-name';
 ...
 *    1. Inicialización de interfaz BLE (init)
 *    2. Deduplicación de contactos por MAC en renderContactsList
 *    3. Integración de pre-conexión GATT al encontrar dispositivos conocidos
 *    4. Ajuste de lógica de navegación al abrir/cerrar chats
 *    5. Refactorización de manejo de estados de conexión y mensajes pendientes
     */
