...
/*
 * FIRMAS:
 *    * v5.1.7-NO-MAC-CLEAN: Refactor de identidad para uso exclusivo de NEXO ID.
 *    * Saneamiento de normalización en deviceId.
 *    * Implementación de persistencia opaca de deviceId en plugins nativos.
     */
