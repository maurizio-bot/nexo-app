/**
 * NEXO App v5.0.17-ACK-JUMP-HEARTBEAT
...
DEBUG.log('NEXO v5.0.17-ACK-JUMP-HEARTBEAT iniciando...', 'info', 'APP_INIT');
}
async init() {
...
DEBUG.success('NEXO v5.0.17-ACK-JUMP-HEARTBEAT Ready', 'APP_READY');
} catch (err) {
...
var msgV2 = null;
/* NUEVO: Parsear formato v2 y legacy */
...
/* NUEVO: Enviar read receipt si chat activo con remitente */
...
/* NUEVO: Iniciar timeout para ACK con retry */
...
var pending = this._pendingMessages.get(messageId);
if (!pending) {
/* NUEVO: Buscar por msgId alternativo */
var foundKey = null;
this._pendingMessages.forEach(function(v, k) {
