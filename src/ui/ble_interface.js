...
if (!mac) return;
self.onDeviceFound({ id: mac, address: mac, name: name, rssi: data.rssi, nexoId: nexoId });
} catch (e) {}
});
...
/*
 * Modificaciones:
 *    1. Implementación de identidad basada exclusivamente en NEXO ID.
 *    2. Eliminación de lógica de deduplicación basada en MAC.
 *    3. Uso de MAC exclusivamente para conexión GATT y mapeo temporal.
 *    4. Actualización del log de inicio con versión corregida.
     */
